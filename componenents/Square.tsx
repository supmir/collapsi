...
export default function Square(props: SquareProps) {
    ...
    return <div
        ...
        <AnimatePresence initial={false}>
            ...
            {hasDisplayedPlayer && <PlayerPiece playerState={playerState} isTurn={playerState.id === gameState.turn} className={`${playerState.id === 1 ? "bg-red-700" : "bg-blue-700"} z-20`} updateBoard={isPlayerTurn ? updateBoard : () => { }} />}
        </AnimatePresence>
    </div>;
}